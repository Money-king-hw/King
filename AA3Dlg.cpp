...
BOOL CAA3Dlg::OnInitDialog()
{
	CDialogEx::OnInitDialog();

	// TODO:  在此添加额外的初始化
	SetTimer(1, 100, NULL);
	old = GetDlgItem(IDC_A3EDIT)->GetScrollPos(SB_VERT);		//获取滑轮位置
...
void CAA3Dlg::OnTimer(UINT_PTR nIDEvent)
{
	...
	case 1:
	{
		int n = GetDlgItem(IDC_A3EDIT)->GetScrollPos(SB_VERT);	//获取滑轮位置
